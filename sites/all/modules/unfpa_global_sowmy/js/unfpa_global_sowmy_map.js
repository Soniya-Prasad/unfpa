/**
 * @file
 * Override the default Main settings, borders,state_specific, regions, continent.
 */
...
(function ($) {
    Drupal.behaviors.unfpa_global_sowmy_map_state_data = {
        attach: function (context, settings) {
            simplemaps_worldmap_mapdata.state_specific = Drupal.settings.unfpa_global_sowmy_map_state_data;
        }
  };
    // This function is called after the map has finished loading.
    simplemaps_worldmap.hooks.complete = function () {
        $('#sowmy-map-scale-wrapper').show();
    };
})(jQuery);
