...
// Check if it's pantheon environment.
if (isset($_SERVER['PANTHEON_ENVIRONMENT'])) {
  $env = $_SERVER['PANTHEON_ENVIRONMENT'];

  if ($env == 'live') {
    $sites['safebirthevenhere.org'] = 'default';
  }
  else {
    $sites["$env-unfpa-global.pantheonsite.io"] = 'default';
  }
}
else {
  $sites["safebirth.$env.unfpa.org"] = 'default';
}
