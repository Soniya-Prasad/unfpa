...
<?php
$color_heat_array = array("No" => "#FF0000", "Yes" => "#33CC33");
...
foreach ($data["indicator_arr"] as $cc => $result) {
  ...
  if (isset($result[$indicator_id])) {
    $color_code_key = $result[$indicator_id];
  ...
  if (!in_array($country_temp_name, $location_static_array)) {
    ...
    $country_arr[$cc]['description'] = "Indicator value : " . $color_code_key;
    ...
    $location_arr[$cnt]['description'] = "Indicator value : " . $color_code_key;
