...
Drupal.behaviors.unContinueReading = {
  attach: function (context, settings) {
    $('.rp-readmore', context).once('unContinueReading', function () {
...
Drupal.behaviors.unRegionIndicators = {
  attach: function (context, settings) {
    $('.region-indicators', context).once('unRegionIndicators', function () {
      var $ri = $(this);
...
Drupal.behaviors.unTiles = {
  attach: function (context, settings) {
    $('.rp-tiles > ul', context).once('unTiles', function () {
      ...
      $('.rp-tile-close').live('click', function() {
        var $items = $tiles.find('li.rp-tile');
        $items.find('.rp-tile-expanded').hide();
        $items.find('.rp-tile-collapsed').show();
...
Drupal.behaviors.unIntro4Cols = {
  attach: function (context, settings) {
    $('.intro-numbcols > ul', context).once('unIntro4Cols', function () {
      var $numbcols = $(this);
