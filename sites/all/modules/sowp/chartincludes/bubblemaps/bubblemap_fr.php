...
<div class="swp-bubblemap">
    ...
    <div class="bubblemap-copy">
        <h4 class="color-text">Sierra Leone</h4>
        <p>Environ 123 000 femmes étaient enceintes pendant la crise Ebola qui a sévi en Sierra Leone en 2015.</p>
        <h4 class="color-text">Népal</h4>
        <p>D’après les estimations de l’UNFPA, environ 126 000 femmes étaient enceintes au moment du tremblement de terre qui a secoué le pays en avril 2015; parmi elles, 21 000 ont eu besoin de soins obstétricaux dans les mois qui ont suivi la catastrophe.</p>
        <h4 class="color-text">Philippines</h4>
        <p>On estime à 250 000 le nombre de femmes enceintes lors du passage du typhon Haiyan en novembre 2013 et à 70 000 celles qui arrivaient à terme au cours du premier trimestre 2014.</p>
        <h4 class="color-text">Vanuatu</h4>
        <p>Lors du passage du cyclone tropical Pam (2015), on comptait environ 8 500 femmes enceintes et allaitantes dans les provinces touchées.</p>
    </div>
      ...
      locations: {
          0: {
              name:
                      ...
                      '<div class="bubb-desc">' + 'Environ 123 000 femmes étaient enceintes pendant la crise Ebola qui a sévi en Sierra Leone en 2015.' +
                      '</div></div>',
              lat: '8.578137',
              lng: '-11.771250',
              color: 'default',
          ...
          1: {
              name:
                      '<div class="bubb-content">' +
                      '<div class="bubb-name">' + Drupal.t('Népal') + '</div>' +
                      '<div class="bubb-desc">' + 'D’après les estimations de l’UNFPA, environ 126 000 femmes étaient enceintes au moment du tremblement de terre qui a secoué le pays en avril 2015; parmi elles, 21 000 ont eu besoin de soins obstétricaux dans les mois qui ont suivi la catastrophe.' +
                      '</div></div>',
              lat: '28.069323',
              lng: '84.215710',
              color: 'default',
          ...
          2: {
              name:
                      ...
                      '<div class="bubb-desc">' + 'On estime à 250 000 le nombre de femmes enceintes lors du passage du typhon Haiyan en novembre 2013 et à 70 000 celles qui arrivaient à terme au cours du premier trimestre 2014.' + '</div></div>',
              lat: '12.049930',
              lng: '122.894732',
              color: 'default',
              description: ''
          ...
          3: {
              name:
                      ...
                      '<div class="bubb-desc">' + 'Lors du passage du cyclone tropical Pam (2015), on comptait environ 8 500 femmes enceintes et allaitantes dans les provinces touchées.' +
                      '</div></div>',
              lat: '-16.189600',
              lng: '167.799147',
              color: 'default',
