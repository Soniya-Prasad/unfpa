...
<div class="swp-bubblemap">
    ...
    <div class="bubblemap-copy">
        ...
        <p>Según las estimaciones, en Sierra Leona, uno de los países afectados por el ébola, había 123.000 embarazadas en 2015.</p>
        <h4 class="color-text">Nepal</h4>
        <p>El UNFPA calcula que había alrededor de 126.000 embarazadas durante el terremoto de abril, entre ellas 21.000 que precisaron atención obstétrica en los meses posteriores.</p>
        <h4 class="color-text">Filipinas</h4>
        <p>Aproximadamente 250.000 mujeres estaban embarazadas cuando el tifón Haiyan alcanzó el país en noviembre de 2013,y unas 70.000 salían de cuentas en el primer trimestre de 2014.</p>
        <h4 class="color-text">Vanuatu</h4>
        <p>Cuando llegó el ciclón tropical Pam (2015), las estimaciones indican que en las provincias afectadas había 8.500 embarazadas y madres lactantes.</p>
    </div>
      ...
      locations: {
          0: {
              name:
                      ...
                      '<div class="bubb-desc">' + 'Según las estimaciones, en Sierra Leona, uno de los países afectados por el ébola, había 123.000 embarazadas en 2015.' +
                      '</div></div>',
              lat: '8.578137',
              lng: '-11.771250',
              color: 'default',
          ...
          1: {
              name:
                      ...
                      '<div class="bubb-desc">' + 'El UNFPA calcula que había alrededor de 126.000 embarazadas durante el terremoto de abril, entre ellas 21.000 que precisaron atención obstétrica en los meses posteriores.' +
                      '</div></div>',
              lat: '28.069323',
              lng: '84.215710',
              color: 'default',
          ...
          2: {
              name:
                      '<div class="bubb-content">' +
                      '<div class="bubb-name">' + Drupal.t('Filipinas') + '</div>' +
                      '<div class="bubb-desc">' + 'Aproximadamente 250.000 mujeres estaban embarazadas cuando el tifón Haiyan alcanzó el país en noviembre de 2013,y unas 70.000 salían de cuentas en el primer trimestre de 2014.' + '</div></div>',
              lat: '12.049930',
              lng: '122.894732',
              color: 'default',
              description: ''
          ...
          3: {
              name:
                      ...
                      '<div class="bubb-desc">' + 'Cuando llegó el ciclón tropical Pam (2015), las estimaciones indican que en las provincias afectadas había 8.500 embarazadas y madres lactantes.' +
                      '</div></div>',
              lat: '-16.189600',
              lng: '167.799147',
              color: 'default',
