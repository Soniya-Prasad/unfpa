 ...
 */
if (!empty($_ENV)) {
  $conf['logs_http_url'] = 'https://logs-01.loggly.com/inputs/704620e7-c3d4-4d84-a0c1-926e5147592c/tag/http/';
  $conf['logs_http_uuid'] = $_ENV['PANTHEON_SITE_NAME'] . '-' . $_ENV['PANTHEON_ENVIRONMENT'];
}

// Require WWW (redirect non www).
if (isset($_SERVER['PANTHEON_ENVIRONMENT']) && $_SERVER['PANTHEON_ENVIRONMENT'] === 'live') {
  if ($_SERVER['HTTP_HOST'] == 'unfpa.com' || $_SERVER['HTTP_HOST'] == 'live-unfpa-global.pantheon.io' || $_SERVER['HTTP_HOST'] == 'live-unfpa-global.pantheonsite.io') {
    header('HTTP/1.0 301 Moved Permanently');
    header('Location: http://www.unfpa.com'. $_SERVER['REQUEST_URI']);
    exit();
  }
}
