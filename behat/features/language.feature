Feature:
  ...
  Examples:
    ...
    | EN        | navigation links | Home, About, Topics, Emergencies, Publications, News, Media centre                |
    | ES        | navigation links | Inicio, Acerca de, Temas, Emergencias, Publicaciones, Noticias, Media centre      |
    | FR        | navigation links | Accueil, À propos, Thèmes, Urgences, Publications, Actualités, Media centre       |
